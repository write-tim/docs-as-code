...
//#region src/expressive-code.d.ts
/**
 ...
 * ```
 */
declare function defineEcConfig(config: StarlightExpressiveCodeOptions): StarlightExpressiveCodeOptions;
//#endregion
export { type StarlightExpressiveCodeOptions, defineEcConfig };